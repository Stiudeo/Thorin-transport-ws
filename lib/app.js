...
module.exports = function(thorin, SocketEvent) {
  ...
  function bindApp(io, adapter) {
    ...
    io.on('connection', (socketObj) => {
      ...
      socketObj.on(ROOM_EVENT_LISTENER.CLEAR, handleClientRoomClear.bind(this, socketObj, SOCKET_EVENT.ROOM_CLEAR, null));
  ...
  function handleClientRoomEvent(socketObj, actionType, roomName, _payload, _fn) {
    ...
    try {
      ...
      logger('error', `Incoming ${actionType} could not handle action`, e);
    }
  }
